    ...
    >
      ...
      <DialogTitle sx={{ pb: 0.5, pt: 2.5, px: 3 }}>
        ...
        >
          <Box sx={{ mb: 4 }}>
            <Typography
              sx={{ fontWeight: 600, fontSize: "20px", color: "text.primary" }}
            >
      ...
      <DialogContent sx={{ px: 3, pt: 2.5, pb: 1 }}>
        ...
        >
          <Box>
            ...
            <TextField
              fullWidth
              size="small"
              placeholder="s.thompson@agency.com"
              value={form.email}
              onChange={set("email")}
              sx={inputSx}
            />
        ...
        >
          ...
          <Box>
            ...
            <Select
              ...
              sx={selectSx}
            >
              <MenuItem value="carer" sx={{ fontSize: "0.82rem" }}>
                Carer (mobile app only)
              </MenuItem>
              <MenuItem value="nurse" sx={{ fontSize: "0.82rem" }}>
                Nurse (mobile app only)
              </MenuItem>
              <MenuItem value="supervisor" sx={{ fontSize: "0.82rem" }}>
                Supervisor (full access)
              </MenuItem>
              <MenuItem value="admin" sx={{ fontSize: "0.82rem" }}>
              ...
              {["ACTIVE", "ONBOARDING"].map((s) => (
                <Box
                  ...
                  sx={{
                    ...
                    borderRadius: "8px",
                    bgcolor:
                      form.initialStatus === s ? "#FFFFFF" : "transparent",
                    boxShadow:
                ...
                >
                  <Typography
                    sx={{
                      ...
                      fontWeight: 700,
                      color:
                        form.initialStatus === s ? "text.primary" : "#94A3B8",
              ...
              control={
                <Checkbox
                  ...
                  onChange={(e) =>
                    setForm((f) => ({
                      ...f,
                      assignableToShifts: e.target.checked,
                    }))
                  }
                  sx={{
                    color: "#0EA5E9",
        ...
        >
          <WarningAmberRoundedIcon
            sx={{ fontSize: 17, color: "#FEA400", mt: 0.1, flexShrink: 0 }}
          />
          <Typography
            sx={{ fontSize: "0.68rem", color: "#FEA400", lineHeight: 1.5 }}
          >
            <strong>Note:</strong> This staff will appear as{" "}
            <strong>Non-Compliant</strong> until required identification and
            training documents are uploaded to their profile.
          </Typography>
        </Box>
      </DialogContent>
