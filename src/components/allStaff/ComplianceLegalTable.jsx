...
const OVERALL_STATUS_STYLES = {
  ...
  "EXPIRING SOON": { bg: "#FFEDD5", color: "#FEA400" },
...
export default function ComplianceLegalTable() {
  ...
  const filtered = complianceRows.filter(
    (r) =>
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((row) => (
                ...
                >
                  ...
                  <TableCell sx={{ borderBottom: ROW_BORDER, py: 1.8 }}>
                    {(() => {
                      const s = OVERALL_STATUS_STYLES[row.overallStatus] ?? {
                        bg: "#f3f4f6",
                        color: "#6b7280",
                    ...
                    {row.problemItems.length === 0 ? (
                      ...
                      <Box sx={{ display: "flex", gap: 0.8, flexWrap: "wrap" }}>
                        {row.problemItems.map((item) => {
                          const s = PROBLEM_ITEM_STYLES[item] ?? {
                            bg: "#f3f4f6",
                            color: "#6b7280",
                          };
                          return (
                  ...
                  <TableCell sx={{ borderBottom: ROW_BORDER, py: 1.8 }}>
                    <Typography
                      fontSize="12px"
                      fontWeight={700}
                      color={row.expiryExpired ? "#F97316" : "text.light"}
                    >
                      {row.nextExpiry}
                    </Typography>
                  </TableCell>
