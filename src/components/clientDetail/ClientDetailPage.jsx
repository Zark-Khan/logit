...
import {
  Box, Typography, Avatar, Button, Chip, Grid
} from "@mui/material";
...
export default function ClientDetailPage() {
  ...
  const renderTab = () => {
    ...
    if (activeTab === "Client Details") return <ClientDetailsTab client={client} />;
    if (activeTab === "Care Assessment") return <CareAssessmentTab client={client} />;
    ...
    if (activeTab === "Schedule & Visits") return <ScheduleVisitsTab client={client} />;
  ...
  return (
    ...
    <Box sx={{ py: 3 }}>
      ...
      >
        ...
        <Typography fontSize="12px" color="#CBD5E1">/</Typography>
