...
const DONUT_DATA = [
  ...
  { name: "Safety", value: 15, color: "#FEA400" },
];
  ...
  return (
    <Paper
      ...
      sx={{
        p: 2.5,
        borderRadius: 3,
        border: "1px solid #5289103D",
        height: "100%",
        backgroundColor: "#DCFCE78C",
        width: "100%",
      }}
    >
  ...
  return (
    <Paper
      ...
      sx={{
        p: 2.5,
        borderRadius: 3,
        border: "1px solid #84919A54",
        height: "100%",
        backgroundColor: "#E2E8F045",
      }}
    >
